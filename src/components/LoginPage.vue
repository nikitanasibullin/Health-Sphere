<template>
  <div class="min-h-screen flex items-center justify-center gradient-bg relative overflow-hidden">
    ...
    <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"></div>
    
    <!-- Login Card -->
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md relative z-10 animate-fadeIn mx-4">
      ...
      <div class="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg text-xs">
        ...
        <p 
          ...
          class="text-gray-600 cursor-pointer hover:text-blue-600"
        >
...
export default {
  ...
  methods: {
    handleLogin() {
      ...
      const user = this.demoUsers[this.form.email]
      ...
      // Navigate to appropriate dashboard using Vue Router
