...
### Назначение роли
Администратор отвечает за конфигурацию и поддержку системы: управление врачами, пациентами, расписаниями, приёмами и медицинскими специализациями.
...
- Поиск врачей по строке поиска
- Удаление врача

#### Управление расписанием
- Создание расписания для врача
- Массовое (пакетное) создание расписаний
- Просмотр расписания конкретного врача
- Удаление элемента расписания

#### Управление приёмами
- Просмотр всех приёмов в системе
- Удаление приёма
...
### Назначение роли
Врач работает с назначенными ему приёмами, ведёт медицинские данные пациентов, назначает медикаменты и управляет противопоказаниями.
...
- Назначение медикаментов в рамках приёма и с ограничениями на противопоказения

#### Работа с медикаментами
- Получение списка медикаментов пациента
- Получение списка активных медикаментов пациента
- Формирование отчёта по медикаментозному лечению пациента

#### Работа с противопоказаниями медикаментов
- Добавление противопоказаний к медикаментам
- Просмотр противопоказаний медикаментов
- Удаление противопоказаний медикаментов

#### Работа с противопоказаниями пациента
- Добавление противопоказаний пациенту
- Удаление противопоказаний пациента
...
- Получение раписания определенного доктора
- Запись к доктору
- Отмена записи
- Получение всех своих записей
- Получение медицинской информации о себе 
